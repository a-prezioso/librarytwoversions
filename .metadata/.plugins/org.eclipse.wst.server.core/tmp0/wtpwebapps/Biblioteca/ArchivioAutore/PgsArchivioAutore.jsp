...
<FORM method="post" action="/Biblioteca/CtrlArchivioAutore" name="ArchivioAutore">
...
<TD>Nome</TD>  
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDAutore" value="<%=((Autore)pgsElenco.get(0)).getChiave() %>" checked="checked"> </TD> 
...
<%while(i< numeroRighe){
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDAutore" value="<%= ((Autore)pgsElenco.get(i)).getChiave() %>" > 
	</TD>
