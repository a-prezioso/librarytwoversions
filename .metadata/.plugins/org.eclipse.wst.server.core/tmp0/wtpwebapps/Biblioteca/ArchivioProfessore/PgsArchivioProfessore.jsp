...
<FORM method="post" action="/Biblioteca/CtrlArchivioProfessore" name="ArchivioProfessore">
<P>&nbsp;&nbsp; <input type="submit" name="cmdAzione" value="Torna alla Home">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="+3">Archivio Professore </font>
</P>
<% ArrayList pgsElenco= (ArrayList) request.getAttribute("elencoProfessore");
...
<TD>Matricola</TD>
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDProfessore" value="<%=((Professore)pgsElenco.get(0)).getChiave() %>" checked="checked"> </TD> 
...
<%while(i< numeroRighe){
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDProfessore" value="<%= ((Professore)pgsElenco.get(i)).getChiave() %>" > 
	</TD>
