...
<body>
<FORM method="post" action="/BibliotecaWebHb/CtrlArchivioCasaEditrice" name="ArchivioCasaEditrice">
<P>&nbsp;&nbsp; <input type="submit" name="cmdAzione" value="Torna alla Home">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="+3">Archivio CasaEditrice </font>
</P>
<% List pgsElenco= (List) request.getAttribute("elencoCasaEditrice");
...
<TD>Nome</TD>  
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDCasaEditrice" value="<%=((CasaEditrice)pgsElenco.get(0)).getId() %>" checked="checked"> </TD> 
...
<%while(i< numeroRighe){
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDCasaEditrice" value="<%= ((CasaEditrice)pgsElenco.get(i)).getId() %>" > 
	</TD>
