...
<body>
<FORM method="post" action="/BibliotecaWebHb/CtrlArchivioGenere" name="ArchivioGenere">
<P>&nbsp;&nbsp; <input type="submit" name="cmdAzione" value="Torna alla Home">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="+3">Archivio Genere </font>
</P>
<% List pgsElenco= (List) request.getAttribute("elencoGenere");
...
<TD>Nome</TD>  
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDGenere" value="<%=((Genere)pgsElenco.get(0)).getId() %>" checked="checked"> </TD> 
...
<%while(i< numeroRighe){
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDGenere" value="<%= ((Genere)pgsElenco.get(i)).getId() %>" > 
	</TD>
