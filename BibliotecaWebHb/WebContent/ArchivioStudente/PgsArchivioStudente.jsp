...
<FORM method="post" action="/BibliotecaWebHb/CtrlArchivioStudente"  name="ArchivioStudente">
<P>&nbsp;&nbsp; <input type="submit" name="cmdAzione" value="Torna alla Home">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<font size="+3">Archivio Studente </font>
</P>
<% List pgsElenco= (List) request.getAttribute("elencoStudente");
...
<TD>Telefono</TD>
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDStudente" value="<%=((Studente)pgsElenco.get(0)).getId() %>" checked="checked"> </TD> 
...
<%while(i< numeroRighe){
	...
	<TR>
	<TD>
	<input type="radio" name="rdoIDStudente" value="<%= ((Studente)pgsElenco.get(i)).getId() %>" > 
	</TD>
	...
	<TD> <%= ((Studente)pgsElenco.get(i)).getDatanascita() %></TD>	
	<TD> <%= ((Studente)pgsElenco.get(i)).getIndirizzo() %></TD>
	<TD> <%= ((Studente)pgsElenco.get(i)).getComune() %></TD>
	<TD> <%= ((Studente)pgsElenco.get(i)).getProvincia() %></TD>
	<TD> <%= ((Studente)pgsElenco.get(i)).getNazione() %></TD>
	<TD> <%= ((Studente)pgsElenco.get(i)).getTelefono() %></TD>
	</TR>
	<% i++;
	} %>	
</TBODY>
